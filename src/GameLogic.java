...
public class GameLogic {
    ...
    public void runGame() {
        ...
        for (int i = 0; i < monsters.size(); i++) {
            ...
            inTokyoGainStar(currentMonster);
            ...
            if (buy > 0 && (currentMonster.energy >= (deck.getStoreCard(buy).getCost()
                ...
                currentMonster.energy += -(deck.getStoreCard(buy).getCost()
                        - currentMonster.cardEffect("cardsCostLess")); // Alient
                // Metabolism
    ...
    private void inTokyoGainStar(Monster currentMonster) {
            if (currentMonster.inTokyo) {
                currentMonster.stars += 1;
            }
    }
